...
APP_NAME=${APP_NAME:-Muzeebra}
BUNDLE_ID=${BUNDLE_ID:-com.portfolio.muzeebra}
...
<dict>
    ...
    <array>
        <dict>
            ...
            <array>
                <string>muzeebra</string>
            </array>
        </dict>
    </array>
    <key>NSAppleEventsUsageDescription</key>
    <string>Muzeebra requires control over Spotify to sync playback states and control music playback.</string>
</dict>
</plist>
PLIST
